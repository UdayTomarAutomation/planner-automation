...
/**
 * @author subhakanta.swain 1.create Plan Header from header 3. Click on Rating
 *         Stream Pop up 4. Add RS from pop up header level 4. Verify it is
 *         displayed from Header UI also after deal save
 * 
 * 
 * 
 */
public class RatingStreamValidationfromHeaderAddedByPopUp extends BaseTest {
	@BeforeTest
	...
	public void ratingStreamValidationfromHeaderAddedByPopUp(String dealName, String PlanClass, String advName,
			String agencyName, String accountExecute, String calendarvalue, String startPeriodValue,
			String endPeriodValue, String dealYearValue, String marketPlaceValue, String flightvalue,
			String channelValue, String demovalue) throws InterruptedException {
		...
		new PlannerHeaderPage(getPageBrowser()).creationPlanHeader(planName, AutoConfigPlannerWorkSpace.planClass,
				...
				marketPlaceValue, flightvalue, "Fox Broadcasting Company", demovalue);
