...
/**
 * @author mansi_vyas 21 Dec, 2022
 *
 */
public class VerifyCreateSimilarLine extends BaseTest {
	@BeforeTest
	...
	public void verifyCreateSimilarLine(String planClass, String station,
		...
		// createSimilarLines
		planworkspace.createSimilarLines(product, 1);
