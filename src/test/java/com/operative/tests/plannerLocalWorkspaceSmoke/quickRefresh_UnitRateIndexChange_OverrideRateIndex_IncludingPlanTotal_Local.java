...
public class  quickRefresh_UnitRateIndexChange_OverrideRateIndex_IncludingPlanTotal_Local extends BaseTest {
	 ...
	 */
      ...
      //click weekly spots value
        ...
        //click Quick Refresh
        workSpacebook.openQuickRefreshBooks().overriddenUnitInedexQuickRefresh().clickQuickRefreshBooks();
		...
		//Expected Cell CPM is cellRate/cellImps
		Double ExpectedCellCPMAfterQuickRefresh = Double.valueOf(cellRate)/Double.valueOf(cellImpsUpdated);
		...
		//Expected Total imps is cellRate/cellImps
		Double ExpectedImpsValueQtrUpdatedAfterQuickRefresh = Double.valueOf(cellImpsAfterQuickRefresh) * Double.valueOf(spotValue);
		Logger.log("ExpectedImpsValueQtrUpdatedAfterQuickRefresh is==> "+ExpectedImpsValueQtrUpdatedAfterQuickRefresh);

		
		//Expected Total CPM is cellRate/cellImps
		Double ExpectedcpmValueQtrUpdatedAfterQuickRefresh = Double.valueOf(grossValueQtr)/Double.valueOf(ExpectedImpsValueQtrUpdatedAfterQuickRefresh);
		...
		getCustomeVerification().verifyEquals(getSoftAssert(), getBasePage().format2Digi(grossValuePlanTotalTabUpdatedAfterQuickRefresh.replace(",", "").replace("$", "")), getBasePage().
				format2Digi(String.valueOf(grossValueQtr.replace(",", "").replace("$", ""))),"rate total qtr and plan total is not expected after quick refresh");
		getCustomeVerification().verifyEquals(getSoftAssert(), getBasePage().format2Digi(impsValuePlanTotalTabUpdatedAfterQuickRefresh.replace(",", "").replace("$", "")), getBasePage().
				format2Digi(String.valueOf(impsValueQtrUpdated.replace(",", "").replace("$", ""))),"imps total qtr and plan total is not expected after quick refresh");
		getCustomeVerification().verifyEquals(getSoftAssert(), getBasePage().format2Digi(cpmValuePlanTotalTabUpdatedAfterQuickRefresh.replace(",", "").replace("$", "")), getBasePage().
				format2Digi(String.valueOf(ExpectedcpmValueQtrUpdatedAfterQuickRefresh)),"cpm total qtr and plan total is not expected after quick refresh");
