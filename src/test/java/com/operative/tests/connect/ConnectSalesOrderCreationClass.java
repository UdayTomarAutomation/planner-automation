 ...
 *
 */
public class ConnectSalesOrderCreationClass extends BaseTest {
	@BeforeTest
	...
	@Test(dataProviderClass = ConnectDataprovider.class, dataProvider = "PlanCreation")
	public void verifyPlanNameInDealList(String orderName, String orderAdvertizer, String primarySalesPerson,
