 ...
 *
 */
public class VerifyProductDisplayingInWorkSpace extends BaseTest{
	@BeforeTest
	...
	public void verifyProductDisplayingInWorkSpace(String dealName,String advName,String agencyName,String accountExecute,String calendarvalue,
			...
			String demovalue)
	{
		...
		getCustomeVerification().verifyEquals(getSoftAssert(), productcount, 1,"product count not same");
