 ...
 *
 */
public class VerifyUnitsValueTotalQtr extends BaseTest {
	@BeforeTest
	...
	@Test(dataProviderClass=PlannerWorkSpaceDataprovider.class,dataProvider="UnitsValueTotalQtr")
	public void verifyUnitsValueTotalQtr(String dealName,String advName,String agencyName,String accountExecute,String calendarvalue,
			...
			String demovalue,String unitstotal) 
	{
		...
		//enter Units value in total
		planworkspace.enterAggregateTotalValueQtr(AutoConfigPlannerWorkSpace.productworkSpace, 
				AutoConfigPlannerWorkSpace.dayPartDisplay, AutoConfigPlannerWorkSpace.unitstotalQtr,unitstotal, 0);
		//save workspace
		planworkspace.clickSaveWorkSpace();
		//get imps value in Aggregate total
		String unitsTotalValue=planworkspace.getAggregateTotalValueQtr(AutoConfigPlannerWorkSpace.productworkSpace, AutoConfigPlannerWorkSpace.dayPartDisplay, 
				AutoConfigPlannerWorkSpace.unitstotalQtr);
		getCustomeVerification().verifyEquals(getSoftAssert(), unitsTotalValue, unitstotal,"total Units value not match");
